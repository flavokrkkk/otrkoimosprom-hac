    ...
    <Popover open={open} onOpenChange={setOpen}>
      <PopoverTrigger asChild>
        <Button
          ...
          role="combobox"
          aria-expanded={open}
          className="w-full justify-start py-6 rounded-xl text-zinc-300 overflow-hidden text-ellipsis whitespace-nowrap bg-neutral-900 shadow-sm border-neutral-900"
        >
          {value
      ...
      >
        <Command className="rounded-2xl shadow-2xl border-2 border-zinc-700 bg-neutral-900">
          <CommandInput
            placeholder="Искать ВУЗ..."
            className="placeholder:text-zinc-500 text-zinc-400"
            onValueChange={onChangeSearchValue}
          />
          <CommandList className="bg-neutral-900 space-y-2">
